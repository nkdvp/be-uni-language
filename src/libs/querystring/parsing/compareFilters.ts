...
class EqFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('EqFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
class NeFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('NeFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
class LtFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('LtFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
class LteFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('LteFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
class GtFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('GtFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
class GteFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('GteFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
class LikeFilter extends Filter {
  ...
  validate(fdCon: FieldDescriptionContainer): ValidationResult {
    return compareFilterValidation('LikeFilter')(
      fdCon,
      this.supportedTypes,
      this.variable,
      this.value,
...
export { EqFilter, NeFilter, LtFilter, LteFilter, GtFilter, GteFilter, LikeFilter };
